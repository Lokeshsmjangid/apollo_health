...
class MedPardy2ndRoundCtrl extends GetxController{
  ...
  List<int> pointsOrder = [200, 400, 600, 800, 1000];
  checkCells(selectedCells){
    if(selectedCells!=null){
      board = List.generate(3, (_) => List.generate(5, (row) => MedpardyBoardCellModel(points: (row + 1) * 100)));
