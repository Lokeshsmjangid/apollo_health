...
class SoloPlayQuestionWithoutExplanation extends StatefulWidget {
  ...
  final VoidCallback? onSwipeLeft; // To trigger swiperKey.currentState?.swipeLeft()

  const SoloPlayQuestionWithoutExplanation({
    Key? key,
  ...
  @override
  State<SoloPlayQuestionWithoutExplanation> createState() => _SoloPlayQuestionWithoutExplanationState();
}

class _SoloPlayQuestionWithoutExplanationState extends State<SoloPlayQuestionWithoutExplanation> {
  ...
  //         apolloPrint(message: 'BannerAd failed to load: $error');
  //         ad.dispose();
  //       },
  //     ),
  //   );
              ...
              children: [
                ...
                Align(
                  ...
                  child: Row(
                    ...
                    children: [
                      GestureDetector(
                        onTap: () => launchURL(url: q.photoByUrl ?? ''),
                        child: addText600(
                          '${q.photoBy ?? ''} ',
                      ...
                      GestureDetector(
                        onTap: () => launchURL(url: q.imageUrlUnsplash ?? ''),
                        child: addText600(
                          '/ Unsplash',
                          color: AppColors.textColor,
                          fontSize: 9,
                ...
                // Image + Timer + Stuck button positions
                Stack(
                  children: [
                    ClipRRect(
                ...
                // Options list as GestureDetectors
