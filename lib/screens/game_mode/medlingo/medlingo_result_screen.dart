...
class MedLingoResult extends StatefulWidget {
  ...
  String? correctAns;
  int hP;
  MedLingoResult({super.key,this.showText,this.showDesc,this.correctAns,this.hP=0});

  @override
  State<MedLingoResult> createState() => _MedLingoResultState();
}

class _MedLingoResultState extends State<MedLingoResult> {
                    ...
                    Row(
                      children: [
                        ...
                        GestureDetector(
                            onTap: (){
                              _timerNew?.cancel();
                              Get.toNamed(AppRoutes.howToLevelUpScreen)?.then((valueeee){
                                _startPeriodicTimer();
                              });
                            },
