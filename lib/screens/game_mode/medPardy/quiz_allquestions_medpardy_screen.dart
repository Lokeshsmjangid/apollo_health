...
class QuizMedpardyAllQuestionsScreen extends StatefulWidget {
  @override
  State<QuizMedpardyAllQuestionsScreen> createState() => _QuizMedpardyAllQuestionsScreenState();
}

class _QuizMedpardyAllQuestionsScreenState extends State<QuizMedpardyAllQuestionsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<MedpardyFinalRoundQuizCtrl>(
        builder: (logic) {
          return SafeArea(
            bottom: false,
            child: Column(
    ...
    return SizedBox.expand(
      ...
      // Header
                ...
                Container(
                    ...
                    child: Row(
                      children: [
                        addText400('Player 3',fontSize: 20,fontFamily: 'Caprasimo',color: AppColors.primaryColor).marginSymmetric(horizontal: 12,vertical: 4),
                        Spacer(),
                        addText400('800',fontFamily: 'Caprasimo',fontSize: 20,color: AppColors.primaryColor).marginSymmetric(horizontal: 12,vertical: 4),
                      ],
                    )
                ).marginOnly(top: 4),
                addHeight(14),
      ...
      // ),
                    ...
                    Column(
                      children: [
                        addText400("Plastic Perception", fontSize: 20,
                            fontFamily: 'Caprasimo'),
                        addText500("Final Round",
                    ...
                    Positioned(
                      ...
                      child: CountdownTimerWidget(
                        ...
                        onTimerEnd: (){
                          ...
                          Get.off(GroupPlayResultScreen(isMadPardy: true));
                          // }
                          // else{
      ...
      /*selectedIndices[qIndex] == null
                                          ? () {
                                        setState(() {selectedIndices[qIndex] = optIndex;
                                        if(optIndex == q.correctIndex){
                                          _playConfettiSound(sound: AppAssets.correctAnswerSound);
                                        }else{
                                          _playConfettiSound(sound: AppAssets.wrongAnswerSound);
      ...
      /*SizedBox(height: 18),
                              if (selectedIndices[qIndex] != null && selectedIndices[qIndex] != q.correctIndex)
                                Padding(
