...
class Medpardy3rdRoundScreen extends StatefulWidget {

  Medpardy3rdRoundScreen();

  @override
  State<Medpardy3rdRoundScreen> createState() => _Medpardy3rdRoundScreenState();
}

class _Medpardy3rdRoundScreenState extends State<Medpardy3rdRoundScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
          ...
          GestureDetector(
            onTap: (){
              showLeaveQuizSheet(context, () {
                Get.delete<MedPardy3rdRoundCtrl>(force: true);
      ...
      body: GetBuilder<MedPardy3rdRoundCtrl>(builder: (logic) {
        return Container(
          decoration: BoxDecoration(
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                      child: addText400(
                                        '${cell.points}',
                                        fontSize: 20,
                                        color: cell.permanentSelected?AppColors.buttonDisableColor
                                            : isSelected
                        ...
                        element.row == logic.selectedCell?.row && element.col == logic.selectedCell?.col)) {
                          ...
                          startMedpardyApi(gameId: gameID, round: 1,categoryId: catID,playerIndex: 0, playerName: players[0].name,
                            ...
                            if(value.status==true && value.data!=null){
                              Get.offNamed(AppRoutes.medpardy3rdRoundQuizScreen, arguments: {
                                'initialTime': false,
                                'game_id': gameID,
                                'round': 3,
