...
import 'health_pro_badge_screen.dart';

class WellnessWatcherBadgeScreen extends StatefulWidget {
  const WellnessWatcherBadgeScreen({super.key});

  @override
  State<WellnessWatcherBadgeScreen> createState() => _WellnessWatcherBadgeScreenState();
}

class _WellnessWatcherBadgeScreenState extends State<WellnessWatcherBadgeScreen> {
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              addHeight(30),
              Image.asset(AppAssets.wellnessWatcherBadge,height: 279,width: 294,),

              Spacer(),
              addText400("Wellness Watcher Madelyn",
              ...
              Expanded(child: addText400(
                  textAlign: TextAlign.center,
                  "You’ve reached 10,000 HP, boosting your medical knowledge. Keep challenging yourself and unlock new achievements!",
