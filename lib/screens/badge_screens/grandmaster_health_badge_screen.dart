...
class GrandmasterHealthBadgeScreen extends StatefulWidget {
  ...
  @override
  State<GrandmasterHealthBadgeScreen> createState() => _GrandmasterHealthBadgeScreenState();
}

class _GrandmasterHealthBadgeScreenState extends State<GrandmasterHealthBadgeScreen> {
          ...
          Column(
            ...
            children: [
              ...
              Expanded(child: addText500(
                  textAlign: TextAlign.center,
                  "You’ve reached 50,000 HP, boosting your medical knowledge. Keep challenging yourself and unlock new achievements!",
