...
void showSoloPlayRulesSheet(BuildContext context) {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                addHeight(20),
                _buildBulletItem('Play at your own pace with 5 timed questions.').marginSymmetric(horizontal: 10),
                _buildBulletItem('Earn HP, badges, and streak rewards.').marginSymmetric(horizontal: 10),
                _buildBulletItem('Use High Stakes Mode to double points—or lose HP if you miss!').marginSymmetric(horizontal: 10),
                _buildBulletItem('How to win: Answer fast and go bold with High Stakes!').marginSymmetric(horizontal: 10),
                /*addHeight(20),
                addText500(
