...
void showMedlingoRulesSheet(BuildContext context) {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                addHeight(20),
                _buildBulletItem('Study the image and riddle—they reveal the word’s theme.').marginSymmetric(horizontal: 10),
                _buildBulletItem('Drag letters to fill the blanks.').marginSymmetric(horizontal: 10),
                _buildBulletItem('Shuffle to refresh your mind; swap letters by sliding them.').marginSymmetric(horizontal: 10),
                _buildBulletItem('Need help? Use the Hand for 10 HP.').marginSymmetric(horizontal: 10),
                _buildBulletItem('How to win: Think fast, use the hints, shuffle smart!').marginSymmetric(horizontal: 10),
                /*addHeight(20),
                addText500(
