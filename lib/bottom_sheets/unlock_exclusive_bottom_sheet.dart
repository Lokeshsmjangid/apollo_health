...
void showUnlockExclusiveSheet(BuildContext context) {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                Align(
                  ...
                  child: GestureDetector(
                    onTap: () async{
                      ...
                      //   await audioPlayer.play(AssetSource(AppAssets.actionButtonTapSound));
                ...
                addHeight(4),
                addText400(
                  'Unlock Exclusive\nFeatures!',fontSize: 32,color: AppColors.secondaryColor,height: 40,
                  textAlign: TextAlign.center, fontFamily: 'Caprasimo', // or another bold playful font

                ),
                addHeight(20),
                addText500(
                  'Upgrade to Apollo Premium and take your experience to the next level.',
                ...
                addHeight(12),
                addText500(
                  'Start with a 7-day free trial (and your subscription afterwards). Cancel anytime—no pressure, just pure fun and learning.',
                  textAlign: TextAlign.center,fontSize: 16,height: 22
                ),
                addHeight(28),
                AppButton(
                  onButtonTap: () async{
