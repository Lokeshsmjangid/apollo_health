          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                addHeight(8),
                addText400(
                  'Request Sent',fontSize: 32,color: AppColors.secondaryColor,height: 40,
                  textAlign: TextAlign.center, fontFamily: 'Caprasimo', // or another bold playful font

                ),
                addHeight(20),
                addText500(
                  'Request sent to selected player(s) and will be added to your Group Play if they join in 60 sec.',
