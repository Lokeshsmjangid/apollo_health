...
void WinnertakeModeSheet(BuildContext context) {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                addHeight(8),
                addText400(
                  'Winner-Take-All Mode',fontSize: 32,color: AppColors.secondaryColor,height: 40,
                  textAlign: TextAlign.center, fontFamily: 'Caprasimo', // or another bold playful font

                ),
                addHeight(20),
                addText500(
                  'One winner claims the full prize pool from this round—every point from every player. Everyone else scores zero. This is where bold moves matter.',
