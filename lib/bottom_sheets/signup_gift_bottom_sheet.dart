...
void showSignUpGiftBottomSheet(BuildContext context) {
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  addHeight(8),
                  addText400(
                    'You’ve got a gift!',fontSize: 28,color: AppColors.secondaryColor,
                    textAlign: TextAlign.center, fontFamily: 'Caprasimo', // or another bold playful font

                  ),
                  addHeight(16),
                  addText500(
                    'Enjoy a free 2000 HP bonus! 🎉 Unlock a Day Pass to try MedLingo or Wheel of Wellness—on us!',
