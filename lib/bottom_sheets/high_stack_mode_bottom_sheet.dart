...
void HighStakeModeSheet(BuildContext context) {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                addHeight(8),
                addText400(
                  'High Stakes Mode',fontSize: 32,color: AppColors.secondaryColor,height: 40,
                  textAlign: TextAlign.center, fontFamily: 'Caprasimo', // or another bold playful font

                ),
                addHeight(20),
                addText500(
                  'Not your average quiz—right answers earn double, wrong ones lose points. Confidence wins, guessing stings!',
