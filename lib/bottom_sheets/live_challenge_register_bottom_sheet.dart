...
void showLiveChallengeRegisterSheet(BuildContext context) {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                addHeight(8),
                addText400(
                  'Not Enough HP',fontSize: 28,color: AppColors.secondaryColor,
                  textAlign: TextAlign.center, fontFamily: 'Caprasimo', // or another bold playful font

                ),
                addHeight(16),
                addText500(
                  'You don’t have enough HP to register right now—but no worries! You can still lock in your spot for just \$0.99.',
                ...
                AppButton(
                  onButtonTap: () async{
                    ...
                    Get.back();
                    Get.toNamed(AppRoutes.timerLiveChallengeScreen);
                  },
                  buttonText: 'Reserve for \$0.99',buttonColor: AppColors.secondaryColor,),
                addHeight(20),
