...
void showMedLingoSheet(BuildContext context) {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                addHeight(8),
                addText400(
                  'MedLingo',fontSize: 28,color: AppColors.secondaryColor,
                  textAlign: TextAlign.center, fontFamily: 'Caprasimo', // or another bold playful font

                ),
                addHeight(16),
                addText500(
                  'Shuffle, drag and drop to uncover the hidden medical word!',
