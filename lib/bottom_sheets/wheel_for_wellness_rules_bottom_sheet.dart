...
void showWheelForWellnessRulesSheet(BuildContext context) {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                addHeight(20),
                _buildBulletItem('Spin to reveal the word puzzle!').marginSymmetric(horizontal: 10),
                _buildBulletItem('Guess letters—green is right, red is wrong.').marginSymmetric(horizontal: 10),
                _buildBulletItem('Not sure? Try common letters or vowels.').marginSymmetric(horizontal: 10),
                _buildBulletItem('Stuck? Use the Hand for help (-50 HP).').marginSymmetric(horizontal: 10),
                _buildBulletItem('How to win: Save the Hand for tricky puzzles!').marginSymmetric(horizontal: 10),
                /*addHeight(20),
                addText500(
