...
Future<NotificationResponseModel> notificationListApi() async {
  ...
  try{
    String url = ApiUrls.notificationListUrl;
  ...
  return NotificationResponseModel.fromJson({}); // please add try catch to use this
  // return NotificationResponseModel.fromJson(data); // please UnComment to print data and remove try catch
}