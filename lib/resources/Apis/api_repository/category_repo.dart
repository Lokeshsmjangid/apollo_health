...
Future<CategoryModel> getAllCategoryApi() async {
  ...
  try{
    String url = ApiUrls.categoryUrl;
  ...
  return CategoryModel.fromJson({}); // please add try catch to use this
  // return CategoryModel.fromJson(data); // please UnComment to print data and remove try catch
}