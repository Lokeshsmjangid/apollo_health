...
Future<RegisterResponseModel> registerPersonalInfoApi({firstName, lastName, ageGroup, country, countryFlag,type}) async {
  ...
  try{
    ...
    String url = ApiUrls.registerPersonalUrl;
