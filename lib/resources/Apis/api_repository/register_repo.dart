...
Future<RegisterResponseModel> registerApi({email,password,passwordConfirm,String? refCode}) async {
  ...
  try{
    ...
    final Map<String, dynamic> map = {
      ...
      // 'referral_code':referralCode,  // through unlink
      'referral_code':refCode, // by textField
      'id':AuthData().userModel?.email==email?AuthData().userModel?.id:null // new implemented
    };
