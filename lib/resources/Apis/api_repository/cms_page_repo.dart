...
Future<CmsResponseModel> cmsApi({setting}) async {
  ...
  try{
    ...
    if (response.statusCode == 200) {
      log("\n response Start-->\n\n $data \n\n<--response End" );
      return CmsResponseModel.fromJson(data);
    } else {
  ...
  return CmsResponseModel.fromJson({}); // please add try catch to use this
  // return CmsResponseModel.fromJson(data); // please UnComment to print data and remove try catch
}