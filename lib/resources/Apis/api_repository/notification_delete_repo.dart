...
Future<CommonModel> notificationRemoveApi({required String apiFor, int? id}) async {
  ...
  try{
    String url = apiFor=="delete"?'${ApiUrls.notificationDeleteUrl}?notification_id=$id': ApiUrls.clearAllNotificationUrl;
