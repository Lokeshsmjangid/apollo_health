...
Future<OnboardingModel> onBoardingApi() async {
  ...
  try{
    String url = ApiUrls.onboardingUrl;
  ...
  return OnboardingModel.fromJson({}); // please add try catch to use this
  // return OnboardingModel.fromJson(data); // please UnComment to print data and remove try catch
}