...
Future<LeaderBoardModel> leaderBoardApi({bool isWeeklyTab = true}) async {
  ...
  String selected=isWeeklyTab?"weekly":"allTime";
  try{
    String url = "${ApiUrls.leaderBoardUrl}?type=$selected";
  ...
  return LeaderBoardModel.fromJson({}); // please add try catch to use this
  // return LeaderBoardModel.fromJson(data); // please UnComment to print data and remove try catch
}