...
Future<RegisterResponseModel> settingsUpdateApi({musicEnabled,onlineStatusVisible}) async {
  ...
  try{
    String url = ApiUrls.settingsUpdateUrl;
    Map<String, dynamic> map = {};
    if(musicEnabled!=null){
      map = {
        'music_enabled':musicEnabled,
      };
    }else if(onlineStatusVisible !=null){
      map = {
