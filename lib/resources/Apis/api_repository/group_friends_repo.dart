...
Future<FriendListModel> getFriendApi({bool isFriendCircle = false,String type = 'global',int page=1,String? search}) async {
  ...
  apolloPrint(message: 'getFriendApi: isFriendCircle:$isFriendCircle\n ');
print('getFriendApi: isFriendCircle:$isFriendCircle');

  try{
    String url = isFriendCircle?ApiUrls.friendListUrl:ApiUrls.groupFriendListUrl;
    if (search != null && search.isNotEmpty) {
      url = "$url?type=$type&page=$page&search=$search";
    } else {
