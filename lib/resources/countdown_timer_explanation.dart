...
class CountdownTimerWidgetExplanation extends StatefulWidget {
  ...
  const CountdownTimerWidgetExplanation({
    Key? key,
  ...
  @override
  State<CountdownTimerWidgetExplanation> createState() => CountdownTimerWidgetExplanationState();
}

class CountdownTimerWidgetExplanationState extends State<CountdownTimerWidgetExplanation> {
  ...
  @override
  void didUpdateWidget(covariant CountdownTimerWidgetExplanation oldWidget) {
    super.didUpdateWidget(oldWidget);
    if (widget.shouldStop && timer != null) {
      timer?.cancel();
      apolloPrint(message: 'timer explanation');
    }
